...
import panda.safari.island.pop.bubble.shooter.R;
...
public class MainActivity extends Activity {
    ...
    static final String SKU_PREMIUM = "fireball";
    static final String SKU_GAS = "energytank";

    // SKU for our subscription (infinite gas)
    static final String SKU_INFINITE_GAS = "rainbowball";
